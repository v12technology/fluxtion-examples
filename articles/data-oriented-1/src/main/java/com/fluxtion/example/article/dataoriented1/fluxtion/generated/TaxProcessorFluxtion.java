...
public class TaxProcessorFluxtion
    implements EventProcessor<TaxProcessorFluxtion>,
  ...
  private final TaxLiabilityCalculator taxLiabilityCalculator_2 =
      new TaxLiabilityCalculator(bookSaleHandler_3, foodSaleHandler_4, hardwareSaleHandler_5);
  private final TaxLiabilityThresholdMonitor taxLiabilityThresholdMonitor_1 =
      new TaxLiabilityThresholdMonitor(taxLiabilityCalculator_2);
  private final TaxLiabilityAlerter taxLiabilityAlerter_0 =
      new TaxLiabilityAlerter(taxLiabilityThresholdMonitor_1);
  // Dirty flags
  ...
  public void handleEvent(BookSaleEvent typedEvent) {
    ...
    if (guardCheck_taxLiabilityThresholdMonitor_1()) {
      isDirty_taxLiabilityThresholdMonitor_1 =
          taxLiabilityThresholdMonitor_1.isTaxLiabilityBreached();
    }
  ...
  public void handleEvent(TaxLiabilityNotificationThresholdEvent typedEvent) {
    ...
    // Default, no filter methods
    isDirty_taxLiabilityThresholdMonitor_1 =
        taxLiabilityThresholdMonitor_1.thresholdUpdated(typedEvent);
    if (guardCheck_taxLiabilityAlerter_0()) {
      taxLiabilityAlerter_0.publishTaxLiabilityWarning();
    }
    // event stack unwind callbacks
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(
          taxLiabilityThresholdMonitor_1, (b) -> isDirty_taxLiabilityThresholdMonitor_1 = b);
    }
  ...
  private boolean guardCheck_taxLiabilityCalculator_2() {
    return isDirty_bookSaleHandler_3 | isDirty_foodSaleHandler_4 | isDirty_hardwareSaleHandler_5;
  }
