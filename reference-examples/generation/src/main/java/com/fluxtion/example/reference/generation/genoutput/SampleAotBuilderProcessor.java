...
public class SampleAotBuilderProcessor
  ...
  private final transient MapRef2ToIntFlowFunction mapRef2ToIntFlowFunction_0 =
  ...
  public void handleEvent(String typedEvent) {
    ...
    if (isDirty_handlerString) {
      mapRef2ToIntFlowFunction_0.inputUpdated(handlerString);
    }
    if (guardCheck_mapRef2ToIntFlowFunction_0()) {
      mapRef2ToIntFlowFunction_0.map();
    }
    afterEvent();
  }
  //EVENT DISPATCH - END
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(mapRef2ToIntFlowFunction_0, "mapRef2ToIntFlowFunction_0");
  ...
  @Override
  public SampleAotBuilderProcessor newInstance() {
    return new SampleAotBuilderProcessor();
  }

  @Override
  public SampleAotBuilderProcessor newInstance(Map<Object, Object> contextMap) {
    return new SampleAotBuilderProcessor();
  }
