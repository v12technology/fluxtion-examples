...
public class GlobalPnlProcessor
  ...
  private final SinkPublisher globalPnl = new SinkPublisher<>("globalPnl");
  ...
  private boolean isDirty_globalPnl = false;
  //Forked declarations
  ...
  public void handleEvent(SinkDeregister typedEvent) {
    auditEvent(typedEvent);
    switch (typedEvent.filterString()) {
        //Event Class:[com.fluxtion.runtime.output.SinkDeregister] filterString:[globalPnl]
      case ("globalPnl"):
        isDirty_globalPnl = true;
        globalPnl.unregisterSink(typedEvent);
        afterEvent();
        return;
    }
    afterEvent();
  ...
  public void handleEvent(SinkRegistration typedEvent) {
    auditEvent(typedEvent);
    switch (typedEvent.filterString()) {
        //Event Class:[com.fluxtion.runtime.output.SinkRegistration] filterString:[globalPnl]
      case ("globalPnl"):
        isDirty_globalPnl = true;
        globalPnl.sinkRegistration(typedEvent);
        afterEvent();
        return;
    }
    afterEvent();
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(globalPnl, () -> isDirty_globalPnl);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(globalPnl, (b) -> isDirty_globalPnl = b);
    }
