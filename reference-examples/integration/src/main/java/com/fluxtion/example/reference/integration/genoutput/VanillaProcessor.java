...
public class VanillaProcessor
  ...
  public VanillaProcessor(Map<Object, Object> contextMap) {
    if (context != null) {
  ...
  @Override
  public VanillaProcessor newInstance() {
    return new VanillaProcessor();
  }

  @Override
  public VanillaProcessor newInstance(Map<Object, Object> contextMap) {
    return new VanillaProcessor();
  }
