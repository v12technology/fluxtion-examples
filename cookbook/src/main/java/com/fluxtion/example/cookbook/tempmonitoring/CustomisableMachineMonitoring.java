...
public class CustomisableMachineMonitoring {
    ...
    public static void main(String[] args) {
        ...
        tempMonitor.onEvent(new MachineProfile("server_AMZN", LocationCode.USA_EAST_1, 95, 50));
        tempMonitor.onEvent(new MachineProfile("server_MSFT", LocationCode.USA_EAST_2,95, 50));
        tempMonitor.onEvent(new MachineProfile("server_TKM", LocationCode.USA_EAST_2,95, 50));
