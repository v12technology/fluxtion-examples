...
* <ul>
*   <li>com.fluxtion.compiler.generation.model.ExportFunctionMarker</li>
*   <li>com.fluxtion.example.cookbook.ml.linearregression.api.HouseSaleDetails</li>
*   <li>com.fluxtion.example.cookbook.ml.linearregression.node.ReCalibrationCompleteEvent</li>
*   <li>com.fluxtion.runtime.time.ClockStrategy.ClockStrategyEvent</li>
* </ul>
* @author Greg Higgins
*/
@SuppressWarnings({"unchecked", "rawtypes"})
public class OpportunityMlProcessor implements
EventProcessor<OpportunityMlProcessor>, StaticEventProcessor, InternalEventProcessor, BatchHandler, Lifecycle , CalibrationProcessor, HouseSalesMonitor, OpportunityNotifier{
...
//Node declarations
    ...
    private final DefaultEventHandlerNode handlerHouseSaleDetails = new DefaultEventHandlerNode<>(2147483647, "", com.fluxtion.example.cookbook.ml.linearregression.api.HouseSaleDetails.class, "handlerHouseSaleDetails", context);
    private final FilterFlowFunction filterFlowFunction_1 = new FilterFlowFunction<>(handlerHouseSaleDetails, HousePipelineFunctions::bedroomWithinRangeFilter);
    private final FilterFlowFunction filterFlowFunction_2 = new FilterFlowFunction<>(filterFlowFunction_1, HousePipelineFunctions::correctLocationFilter);
    private final PropertyToFeature area = new PropertyToFeature<>("area", filterFlowFunction_2, HouseSaleDetails::getArea);
    private final MapPropertyToFeature areaSquared = new MapPropertyToFeature<>("areaSquared", filterFlowFunction_2, HouseSaleDetails::getArea, HousePipelineFunctions::squared);
    private final PropertyToFeature bedroom = new PropertyToFeature<>("bedroom", filterFlowFunction_2, HouseSaleDetails::getBedrooms);
    private final LocationCategoryFeature locationCategoryFeature = new LocationCategoryFeature(filterFlowFunction_2);
    private final PropertyToFeature offerPrice = new PropertyToFeature<>("offerPrice", filterFlowFunction_2, HouseSaleDetails::getOfferPrice);
    private final PredictiveLinearRegressionModel predictiveLinearRegressionModel_3 = new PredictiveLinearRegressionModel(new Feature[]{offerPrice, area, areaSquared, locationCategoryFeature, bedroom});
    private final OpportunityNotifierNode opportunityNotifierNode_0 = new OpportunityNotifierNode(predictiveLinearRegressionModel_3, liveHouseSalesCache_4);
...
private final IdentityHashMap<Object, BooleanSupplier> dirtyFlagSupplierMap = new IdentityHashMap<>(9);
private final IdentityHashMap<Object, Consumer<Boolean>> dirtyFlagUpdateMap = new IdentityHashMap<>(9);
    ...
    public void onEventInternal(Object event) {
     ...
     else if (event instanceof com.fluxtion.example.cookbook.ml.linearregression.node.ReCalibrationCompleteEvent) {
...
auditEvent(typedEvent);
        //Default, no filter methods
                    ...
                    if(isDirty_filterFlowFunction_1) {
                        ...
                        isDirty_predictiveLinearRegressionModel_3 = predictiveLinearRegressionModel_3.calculateInference();
                }
...
beforeServiceCall("public default boolean com.fluxtion.runtime.ml.CalibrationProcessor.resetToOne()");
...
beforeServiceCall("public default boolean com.fluxtion.runtime.ml.CalibrationProcessor.resetToZero()");
ExportFunctionAuditEvent typedEvent = functionAudit;
...
beforeServiceCall("public boolean com.fluxtion.example.cookbook.ml.linearregression.node.LiveHouseSalesCache.setCalibration(java.util.List<com.fluxtion.runtime.ml.Calibration>)");
ExportFunctionAuditEvent typedEvent = functionAudit;
                        liveHouseSalesCache_4.setCalibration(arg0);
	                        ...
	                        isDirty_predictiveLinearRegressionModel_3 = predictiveLinearRegressionModel_3.setCalibration(arg0);
	                        opportunityNotifierNode_0.setCalibration(arg0);
	afterServiceCall();
return true;}
@Override
public void houseSold(com.fluxtion.example.cookbook.ml.linearregression.api.HouseSaleDetails arg0){
beforeServiceCall("public void com.fluxtion.example.cookbook.ml.linearregression.node.LiveHouseSalesCache.houseSold(com.fluxtion.example.cookbook.ml.linearregression.api.HouseSaleDetails)");
ExportFunctionAuditEvent typedEvent = functionAudit;
...
beforeServiceCall("public void com.fluxtion.example.cookbook.ml.linearregression.node.LiveHouseSalesCache.removeAllSales()");
ExportFunctionAuditEvent typedEvent = functionAudit;
...
beforeServiceCall("public void com.fluxtion.example.cookbook.ml.linearregression.node.OpportunityNotifierNode.setEnableNotifications(boolean)");
ExportFunctionAuditEvent typedEvent = functionAudit;
                        opportunityNotifierNode_0.setEnableNotifications(arg0);
	afterServiceCall();
}
@Override
public void setNotificationSink(java.util.function.Consumer<java.util.Collection<com.fluxtion.example.cookbook.ml.linearregression.api.PotentialOpportunity>> arg0){
beforeServiceCall("public void com.fluxtion.example.cookbook.ml.linearregression.node.OpportunityNotifierNode.setNotificationSink(java.util.function.Consumer<java.util.Collection<com.fluxtion.example.cookbook.ml.linearregression.api.PotentialOpportunity>>)");
ExportFunctionAuditEvent typedEvent = functionAudit;
...
beforeServiceCall("public void com.fluxtion.example.cookbook.ml.linearregression.node.OpportunityNotifierNode.setProfitTrigger(double)");
ExportFunctionAuditEvent typedEvent = functionAudit;
...
private void initialiseAuditor(Auditor auditor){
	auditor.init();
auditor.nodeRegistered(liveHouseSalesCache_4, "liveHouseSalesCache_4");auditor.nodeRegistered(opportunityNotifierNode_0, "opportunityNotifierNode_0");auditor.nodeRegistered(locationCategoryFeature, "locationCategoryFeature");auditor.nodeRegistered(callbackDispatcher, "callbackDispatcher");auditor.nodeRegistered(filterFlowFunction_1, "filterFlowFunction_1");auditor.nodeRegistered(filterFlowFunction_2, "filterFlowFunction_2");auditor.nodeRegistered(subscriptionManager, "subscriptionManager");auditor.nodeRegistered(areaSquared, "areaSquared");auditor.nodeRegistered(predictiveLinearRegressionModel_3, "predictiveLinearRegressionModel_3");auditor.nodeRegistered(area, "area");auditor.nodeRegistered(bedroom, "bedroom");auditor.nodeRegistered(offerPrice, "offerPrice");auditor.nodeRegistered(handlerHouseSaleDetails, "handlerHouseSaleDetails");auditor.nodeRegistered(context, "context");}
    ...
    public BooleanSupplier dirtySupplier(Object node) {
        if(dirtyFlagSupplierMap.isEmpty()){
                        dirtyFlagSupplierMap.put(area, () -> isDirty_area);            dirtyFlagSupplierMap.put(areaSquared, () -> isDirty_areaSquared);            dirtyFlagSupplierMap.put(bedroom, () -> isDirty_bedroom);            dirtyFlagSupplierMap.put(filterFlowFunction_1, () -> isDirty_filterFlowFunction_1);            dirtyFlagSupplierMap.put(filterFlowFunction_2, () -> isDirty_filterFlowFunction_2);            dirtyFlagSupplierMap.put(handlerHouseSaleDetails, () -> isDirty_handlerHouseSaleDetails);            dirtyFlagSupplierMap.put(locationCategoryFeature, () -> isDirty_locationCategoryFeature);            dirtyFlagSupplierMap.put(offerPrice, () -> isDirty_offerPrice);            dirtyFlagSupplierMap.put(predictiveLinearRegressionModel_3, () -> isDirty_predictiveLinearRegressionModel_3);
        }
    ...
    public void setDirty(Object node, boolean dirtyFlag) {
        if(dirtyFlagUpdateMap.isEmpty()){
                     dirtyFlagUpdateMap.put(area, (b) -> isDirty_area = b);            dirtyFlagUpdateMap.put(areaSquared, (b) -> isDirty_areaSquared = b);            dirtyFlagUpdateMap.put(bedroom, (b) -> isDirty_bedroom = b);            dirtyFlagUpdateMap.put(filterFlowFunction_1, (b) -> isDirty_filterFlowFunction_1 = b);            dirtyFlagUpdateMap.put(filterFlowFunction_2, (b) -> isDirty_filterFlowFunction_2 = b);            dirtyFlagUpdateMap.put(handlerHouseSaleDetails, (b) -> isDirty_handlerHouseSaleDetails = b);            dirtyFlagUpdateMap.put(locationCategoryFeature, (b) -> isDirty_locationCategoryFeature = b);            dirtyFlagUpdateMap.put(offerPrice, (b) -> isDirty_offerPrice = b);            dirtyFlagUpdateMap.put(predictiveLinearRegressionModel_3, (b) -> isDirty_predictiveLinearRegressionModel_3 = b);
        }
